(() => {
  ...
  const W = {
    loopCreate: function () {
      ...
      for (let e = 0; e < l.length; e += 1)
        n.append(k(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
  ...
  function R(e) {
    ...
    c && o.target && o.target.shadowRoot && p && (d = k(p[0]));
  ...
  function X(e) {
    ...
    if (!s.allowTouchMove)
      return (
        k(o.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    t({
      ...
      s("click", (t, s) => {
        const { $nextEl: n, $prevEl: r } = e.navigation,
          a = s.target;
        if (e.params.navigation.hideOnClick && !k(a).is(r) && !k(a).is(n)) {
          if (
            e.pagination &&
            e.params.pagination &&
  ...
  function me({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(r), (e.pagination.bullets = n.find(he(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((r = t.renderFraction
    ...
    fe(),
      document.querySelector(".testimonials__slider") &&
        new ce(".testimonials__slider", {
          ...
          simulateTouch: !1,
          navigation: {
            prevEl: ".slider-testimonials_prev",
            nextEl: ".slider-testimonials_next",
          },
          pagination: { el: ".slider-testimonials__pagination", clickable: !0 },
          on: {},
        }),
      document.querySelector(".slider-team__slider") &&
        new ce(".slider-team__slider", {
          modules: [ue],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          loop: !0,
          navigation: {
            prevEl: ".slider-team_prev",
            nextEl: ".slider-team_next",
          },
          breakpoints: {
  ...
  const ve = document.querySelectorAll(".direction__filter-btn"),
    be = document.querySelectorAll(".cards-direc__item");
  ve.forEach((e) => {
    e.addEventListener("click", (t) => {
      ve.forEach((e) => {
        e.classList.remove("direction__filter-btn_active");
      }),
        e.classList.add("direction__filter-btn_active");
      let s = t.target.dataset.filter;
      be.forEach((e) => {
        e.classList.remove("hide"),
          e.classList.contains(s) || "all" === s || e.classList.add("hide");
      });
    });
  }),
    ymaps.ready(function () {
      var e = new ymaps.Map("map", {
        controls: [],
        center: [59.93001769392692, 30.29003758556858],
        zoom: 13,
      });
      let t = new ymaps.Placemark(
        [59.93001769392692, 30.29003758556858],
        {
          balloonContentHeader: "Royal Ln. Mesa, New Jersey",
          balloonContentBody: "Москва, Никольская 90/1 литера 1",
          balloonContentFooter: "(405) 555-0128",
        },
        {
  ...
  document.querySelector(".menu").addEventListener("click", function (e) {
    let t = e.target;
    if (t.closest(".menu__link")) {
      e.preventDefault();
      let s = t.getAttribute("href").substring(1);
  ...
  var we;
  document
    .querySelector(".footer__bottom-goto")
    ...
    (p.inputMaskModule = new c({ logging: we }));
})();
